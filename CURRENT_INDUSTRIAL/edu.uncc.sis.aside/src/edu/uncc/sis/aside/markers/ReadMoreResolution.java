...
IMarkerResolution2{
	...
	public void run(IMarker marker) {
	   ...
	   // IWebBrowser webBrowser = PlatformUI.getWorkbench().getBrowserSupport().createBrowser("myId");
	    ...
	    logger.info(dateFormat.format(date) + " " + AsidePlugin.getUserId() + " chose ReadMore option to read the webpage of <webpageType>" + ruleNameBelongTo + "<webpageType> for the warning " + "at line "
