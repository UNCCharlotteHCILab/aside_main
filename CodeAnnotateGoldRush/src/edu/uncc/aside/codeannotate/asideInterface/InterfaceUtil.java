...
public  class InterfaceUtil 
{
	...
	public static void clearAndSetHighlighting(int markerNumber, IMarker callingMarker)
	{
		...
		int tempIndex = -1;
		String markerType;
		int callingIndex = callingMarker.getAttribute("markerIndex", -1);
		int secondIndex = callingMarker.getAttribute("secondIndex", -1); //this will be -1 if the marker is an annotation request. This is ok since changeAnnotationHighlighting handles it properly
