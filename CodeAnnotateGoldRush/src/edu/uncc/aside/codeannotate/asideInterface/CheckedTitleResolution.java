...
public class CheckedTitleResolution implements IMarkerResolution,
IMarkerResolution2{
	

	String label;
    CheckedTitleResolution(String label) {
       this.label = label;
    }
    ...
    public void run(IMarker marker) {
       MessageDialog.openInformation(null, "Green Check Demo", "This quick-fix is not yet implemented");
	...
	public String getDescription() {
		// TODO Auto-generated method stub
		 return edu.uncc.aside.codeannotate.asideInterface.VariablesAndConstants.ANNOTATION_REQUEST_BOUND_RESOLUTION_DESC;
	}
	@Override
