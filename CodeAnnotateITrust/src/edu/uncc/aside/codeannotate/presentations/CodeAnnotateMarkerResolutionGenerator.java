 ...
 *
 */
public class CodeAnnotateMarkerResolutionGenerator implements
	 ...
	 */
	public CodeAnnotateMarkerResolutionGenerator() {
	...
	public IMarkerResolution[] getResolutions(IMarker marker) {
		...
		if (hasResolutions(marker)) {
			...
			readMoreResolution = new ReadMoreMarkerResolution();
