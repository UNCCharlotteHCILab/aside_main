...
public class OutputEncodingPoint extends Point implements IPoint {

	public OutputEncodingPoint(ASTNode _node, CompilationUnit unit,
			IResource resource) {
	...
	public String getLineNumberText() {
		...
		return "Output Encoding Warning at Line " + unit.getLineNumber(node.getStartPosition()) + " of  "
				+ resource.getName();
	}
