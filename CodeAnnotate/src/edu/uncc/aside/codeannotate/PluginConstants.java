...
public class PluginConstants {
	...
	public static final String MARKER_MULTI_OUTPUT_ENCODING = "multiple.output.aside.marker";
...
//the following ENCODING_TYPES is for the education version use
	...
	public static final int OUTPUT_IGNORE_RANK_NUM = 2;
	public static final int OUTPUT_NOTICE_LABEL_RANK_NUM = 3;
	public static final int INPUT_IGNORE_RANK_NUM = 2;
	public static final int INPUT_NOTICE_LABEL_RANK_NUM = 3;
	public static final String TOOL_TIP_INPUT ="" + Plugin.PLUGIN_NAME + " potential security vulnerability: accessing unvalidated input";// "ASIDE has flagged this code as potentially vulnerable. Left click the icon to find out why.";
	public static final String TOOL_TIP_OUTPUT ="" + Plugin.PLUGIN_NAME + " potential security vulnerability: unsanitized output";
	public static final String TOOL_TIP_SQL ="" + Plugin.PLUGIN_NAME + " potential security vulnerability: SQL Injection";
