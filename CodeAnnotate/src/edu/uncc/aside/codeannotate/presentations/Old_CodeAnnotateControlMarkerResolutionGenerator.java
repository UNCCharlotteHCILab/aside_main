 ...
 *
 */
public class Old_CodeAnnotateControlMarkerResolutionGenerator implements
	...
	public Old_CodeAnnotateControlMarkerResolutionGenerator() {
	...
	public IMarkerResolution[] getResolutions(IMarker marker) {
		if (hasResolutions(marker)) {
			...
			undoResolution = new Old_CheckUndoResolution();
