 ...
 *         Charlotte</a>
 */
public class Old_AsidePlugin extends AbstractUIPlugin {

	public static Date END_DAY_SEND_LOGS;
	// The shared instance
	private static Old_AsidePlugin plugin;
	...
	public static void setAllowed(boolean isAllowed) {
		Old_AsidePlugin.isAllowed = isAllowed;
	}
	...
	public void start(BundleContext context) throws Exception {
		...
		//below are newly added April 9th
		// newly added
			//	String userIDFromSystem = System.getProperty("user.name");
	...
	private void configure() {
		...
		try {
			...
			if (propertiesInputStream != null) {
				...
				this.loggingManager.hookPlugin(Old_AsidePlugin.getDefault()
						.getBundle().getSymbolicName(), Old_AsidePlugin
						.getDefault().getLog());
			}
	 ...
	 */
	public static Old_AsidePlugin getDefault() {
		return plugin;
	}
	...
	public void setMarkerIndex(
		...
		Old_AsidePlugin.markerIndex.put(project, markerIndex);
	}
