...
//		System.out.println("test");
		...
		if (isMethodInvocation) {
			...
			//System.out.println("The declarationClass is " + declarationClass);
						...
						if (entry instanceof ReturnedTrustBoundary
							...
							if (entryName.equals(methodName)
								...
								//for(String temp: attrTypes)
									//System.out.println("attrTypes " + temp);
								...
								//System.out.println("The typeNameBelongTo is " + typeNameBelongTo);
								
								//System.out.println("The ruleNameBelongTo is " + ruleNameBelongTo);
								return true;
							}
						}
					}
				...
				synchronized (inventory) {
					...
					while (iterator.hasNext()) {
						...
						if (entry instanceof NonReturnedTrustBoundary
							...
							System.out.println("hell"+ entryClass+ " "+declarationClass);
