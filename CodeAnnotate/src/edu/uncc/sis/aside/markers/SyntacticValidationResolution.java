...
//	private IProject fProject;
	...
	public String getDescription() {
		...
		if(fInputType.equals("SafeString")){
			...
			description = "Filename Validation will only allow filenames consisting of valid filename characters, followed by a dot and a file extension. All other characters or formats will throw an exception.";
...
*/
	...
	public String getLabel() {
		...
		if(fInputType.equals("SafeString"))
			labelStr= "11- Allow Only Alphabetical Characters and Numbers"; //102 - 
	/*	else if(fInputType.equals("HttpServletPath"))
			labelStr= "Filter HttpServletPath";*/
		else if(fInputType.equals("HTTPParameterValue"))
			labelStr= "12- Allow Only Minimal HTTP Characters"; //103 - 
		else if(fInputType.equals("URL"))
			labelStr= "13- Allow Only URL Characters"; //104 - 
		else if(fInputType.equals("CreditCard"))
			labelStr= "14- Allow Only Credit Card Numbers"; //105 - 
		else if(fInputType.equals("Email"))
			labelStr= "15- Allow Only Email Addresses"; //106 - 
		else if(fInputType.equals("SSN"))
			labelStr= "16- Allow Only Social Security Number"; //107 - 
		else if(fInputType.equals("FileName"))
			labelStr= "17- Allow Only Valid File Names"; //107 - 
		return labelStr;
	}
